...
TEXTS = {
    # ─── Start & Menu ───
    "welcome": (
        "🎯 <b>Добро пожаловать в Oson Reklama!</b>\n\n"
        "Мы предоставляем услугу размещения рекламы\n"
        "в Telegram-каналах по всему Узбекистану.\n\n"
        "📢 Разместите рекламу или зарегистрируйте свой канал!"
    ),
    ...
    "payment.screenshot_received": (
        "✅ Скриншот получен!\n\n"
        "Заказ будет подтверждён после проверки админом.\n"
        "Ожидайте..."
    ),
