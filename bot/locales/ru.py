...
TEXTS = {
    ...
    "payment.confirmed": "✅ Оплата подтверждена! Владелец канала опубликует рекламу в течение дня.",
    ...
    "owner.publish_instruction": (
        "📢 <b>Опубликуйте рекламу!</b>\n\n"
        "Заказ: <b>#{order_id}</b>\n"
        "Канал: <b>{channel}</b>\n\n"
        "⬇️ Ниже будет рекламный материал.\n"
        "Пожалуйста, опубликуйте его на канале <b>в течение дня</b>\n"
        "и нажмите \"📢 Опубликовано\"."
    ),
    ...
    "notify.ad_published": (
        "📢 <b>Реклама опубликована!</b>\n\n"
        "Заказ: #{order_id}\n"
        "Канал: {channel}\n\n"
        "Ваша реклама успешно размещена! ✅"
    ),
    ...
    "about": (
        ...
        "и заработка в Telegram-каналах по всему Узбекистану.\n\n"
        "🔹 <b>Возможности бота:</b>\n\n"
        "📺 <b>Для рекламодателей:</b>\n"
        "  • Поиск среди 1000+ каналов и групп\n"
        "  • Фильтр по области, району и категории\n"
        "  • Сравнение цен и выбор лучшего\n"
        "  • Размещение рекламы от 10,000 сўм\n"
        "  • Отслеживание статуса и статистики\n"
        "  • Скидки по промокодам\n\n"
        "📺 <b>Для владельцев каналов:</b>\n"
        "  • Бесплатная регистрация канала\n"
        "  • Приём рекламных заказов\n"
        "  • Установка своих цен\n"
        "  • Оплата прямо на вашу карту\n"
        "  • Статистика дохода\n\n"
        "🎁 <b>Дополнительно:</b>\n"
        "  • Поддержка 10 языков\n"
        "  • Бот работает 24/7\n\n"
    ...
    "about.support_prompt": (
        ...
        "Задайте вопрос, опишите проблему или предложение.\n"
        "Админ ответит в ближайшее время! 💬"
    ),
    "about.support_sent": "✅ Ваше сообщение отправлено админам! Ожидайте ответа. 📬",
    "about.support_error": "⚠️ Ошибка отправки. Попробуйте ещё раз.",
