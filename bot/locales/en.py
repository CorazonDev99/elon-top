...
TEXTS = {
    ...
    "owner.no_channels": "📭 You don't have channels/groups yet.\n\nAdd one and start receiving ad orders!",
    "owner.add_channel": "➕ Add Channel/Group",
    ...
    "bulk.select_channels": "📦 <b>Bulk Order</b>\n\nSelect channels (2+ = 15% discount!)\n✅ marked are selected:",
    "bulk.summary": "📦 <b>Bulk Order Summary</b>\n\n📺 Channels ({count}):\n{channels}\n\n💰 Total: <s>{total} UZS</s>\n🏷 Discount (15%): -{discount} UZS\n✅ <b>Final: {final} UZS</b>",
